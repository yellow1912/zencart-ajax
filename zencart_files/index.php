 ...
 */
  if($Ajax->startBlock('head')){ // ajax module add-on
	  require($template->get_template_dir('html_header.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/html_header.php');
	  $Ajax->endBlock(); // ajax module add-on
  }
/**
 ...
 */
  if($Ajax->startBlock('body')){ // ajax module add-on
 ...
 */
?>
<?php $Ajax->loadCssJs(); // ajax module add-on?>
<?php $Ajax->end(); // ajax module add-on?>
